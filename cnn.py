...
def cnn_model(x, init_weights, hparams):
	...
	with tf.name_scope('conv1'):
		W_conv1 = weight_variable([1, 3, hparams.num_input_channels, hparams.num_conv1_features])
	...
	# 	h_conv3_flat = tf.reshape(h_conv3, [-1, hparams.num_coins])
	...
	h_conv2_flat = tf.reshape(h_conv2_weights, [-1, hparams.num_coins*(hparams.num_conv2_features+1)])
	#h_conv2_flat = tf.reshape(h_conv2, [-1, hparams.num_coins*hparams.num_conv2_features])
